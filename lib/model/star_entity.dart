class StarEntity {
	...
	StarEntity.fromJson(Map<String, dynamic> json) {
		...
		sshUrl = json['ssh_url'];
		license = json['license'] != null ? new StarLicense.fromJson(json['license']) : null;
		...
		owner = json['owner'] != null ? new StarOwner.fromJson(json['owner']) : null;
...
class StarLicense {
	...
	StarLicense({this.name, this.spdxId, this.key, this.url, this.nodeId});

	StarLicense.fromJson(Map<String, dynamic> json) {
		name = json['name'];
		spdxId = json['spdx_id'];
		key = json['key'];
		url = json['url'];
...
class StarOwner {
	...
	StarOwner({this.gistsUrl, this.reposUrl, this.followingUrl, this.starredUrl, this.login, this.followersUrl, this.type, this.url, this.subscriptionsUrl, this.receivedEventsUrl, this.avatarUrl, this.eventsUrl, this.htmlUrl, this.siteAdmin, this.id, this.gravatarId, this.nodeId, this.organizationsUrl});

	StarOwner.fromJson(Map<String, dynamic> json) {
